...
class MemberInfoTest {
    ...
    MemberInfo memberInfo1 = new MemberInfo(member1, "테스터1", 20001231, EGender.MAN, "010-1111-1111", "test1@naver.com",
        ELoginPlatform.NONE, null);
    MemberInfo memberInfo2 = new MemberInfo(member2, "테스터2", 20000101, EGender.WOMAN,  "010-2222-2222", "test2@naver.com",
        ELoginPlatform.NONE, null);
    MemberInfo memberInfo3 = new MemberInfo(member3, "테스터3", 20000101, EGender.MAN,  "010-9999-9999", "test3@naver.com",
        ELoginPlatform.NONE, null);
    ...
    void setContact() {
        ...
        assertThrows(UserInsertFailedException.class, () -> new MemberInfo(member3, "테스터3", 20000101, EGender.WOMAN, "01033333333",
                "test3@naver.com", ELoginPlatform.NONE, null));
    }
    ...
    void setBirthDay() {
        // 태어나지 않은 생년월일 에러
        assertThrows(UserInsertFailedException.class, () -> new MemberInfo(member1, "테스터1", 29990101, EGender.MAN,  "010-1111-1111",
            "test1@naver.com", ELoginPlatform.NONE, null));
    }
